...
DEFAULT_MODELS = [
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-sonnet-thinking-low",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=16000,
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-sonnet-thinking-medium",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=32000,
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-sonnet-thinking-high",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=64000,
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-opus-thinking-low",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=16000,
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-opus-thinking-medium",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=32000,
    ...
    ModelConfig(
        ...
        provider="antigravity",
        alias="antigravity-claude-opus-thinking-high",
        input_price=0.0,
        output_price=0.0,
        context=200000,
        max_output=64000,
    ...
    ModelConfig(
        name="gemini-3-flash",
        provider="antigravity",
        alias="antigravity-gemini-3-flash",
        input_price=0.0,
        output_price=0.0,
        context=1048576,
        max_output=8192,
